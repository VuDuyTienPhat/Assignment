...
var AppComponent = /** @class */ (function () {
    function AppComponent(ds, route, router) {
        this.ds = ds;
        this.route = route;
        this.router = router;
    ...
    AppComponent.prototype.ngOnInit = function () {
        var _this = this;
        this.ds.getSubjects().subscribe(function (data) {
            _this.danhmuc = data;
        });
    };
...
/* harmony import */ var ngx_countdown__WEBPACK_IMPORTED_MODULE_23__ = __webpack_require__(/*! ngx-countdown */ "./node_modules/ngx-countdown/fesm5/ngx-countdown.js");
...
var DangkiComponent = /** @class */ (function () {
    function DangkiComponent(ds, router) {
        this.ds = ds;
        this.router = router;
        this.formStudent = {
            username: null,
    ...
    DangkiComponent.prototype.Addthongtin = function (studentForm) {
        var _this = this;
        this.ds.postRegister(studentForm.value).subscribe(function (data) {
            if (data['message']) {
...
var DangnhapComponent = /** @class */ (function () {
    function DangnhapComponent(route, router, location, ds) {
        this.route = route;
        this.router = router;
    ...
    DangnhapComponent.prototype.login = function (formLogin) {
        var _this = this;
        ...
        function (data) {
            ...
            _this.router.navigate(['/trangchu']);
        }, function (err) {
...
var DanhmucmonhocComponent = /** @class */ (function () {
    function DanhmucmonhocComponent() {
    }
...
var DoimatkhauComponent = /** @class */ (function () {
    function DoimatkhauComponent(ds, router, route, http) {
        this.ds = ds;
        this.router = router;
        this.route = route;
        this.http = http;
    ...
    DoimatkhauComponent.prototype.DoiMatKhau = function (formControl) {
        var _this = this;
        console.log('_id', this._id);
        this.ds.postDoiMauKhau(this._id, formControl.value).subscribe(function (data) {
            console.log(data);
            alert('đã đổi');
            _this.router.navigate(['/trangchu']);
        });
    ...
    DoimatkhauComponent.ctorParameters = function () { return [
        { type: _service_service__WEBPACK_IMPORTED_MODULE_2__["DataService"] },
        { type: _angular_router__WEBPACK_IMPORTED_MODULE_3__["Router"] },
        { type: _angular_router__WEBPACK_IMPORTED_MODULE_3__["ActivatedRoute"] },
...
var EditinfoComponent = /** @class */ (function () {
    function EditinfoComponent(ds) {
        this.ds = ds;
    }
    EditinfoComponent.prototype.ngOnInit = function () {
        this.username = this.ds.getUsername();
    };
    EditinfoComponent.prototype.luuThayDoi = function (formControl) {
        formControl.reset();
...
var LienheComponent = /** @class */ (function () {
    ...
    LienheComponent.prototype.onSubmit = function () {
        this.firstname = "";
        this.lastname = "";
        this.subject = "";
        alert('đã gửi');
...
var QuenmatkhauComponent = /** @class */ (function () {
    function QuenmatkhauComponent(ds) {
        this.ds = ds;
    ...
    QuenmatkhauComponent.prototype.HienThiMatKhau = function (form) {
        var _this = this;
        this.ds.postQuenMatKhau(form.value).subscribe(function (data) {
            if (data['password']) {
...
var DataService = /** @class */ (function () {
    ...
    DataService.prototype.postRegister = function (user) {
        return this.http.post("api/register", user);
    };
    DataService.prototype.postAuthenticate = function (authCredentials) {
        return this.http.post("api/authenticate", authCredentials);
    };
    DataService.prototype.postQuenMatKhau = function (thongtinUserNameAndEmail) {
        return this.http.post("api/quenmatkhau", thongtinUserNameAndEmail);
    };
    DataService.prototype.postDoiMauKhau = function (_id, formValue) {
    ...
    DataService.prototype.getQuiz = function (Id) {
    ...
    DataService.prototype.getUserPayLoad = function () {
    ...
    DataService.prototype.themTaiKhoan = function (s) {
...
var SuadoitaikhoanComponent = /** @class */ (function () {
    function SuadoitaikhoanComponent(ds) {
        this.ds = ds;
        this.formSudent = {
            id: 0,
            username: "",
    ...
    SuadoitaikhoanComponent.prototype.ngOnInit = function () {
        this.students = this.ds.students;
    };
    SuadoitaikhoanComponent.prototype.ShowEditStudent = function (student) {
        this.formSudent = {
            id: student.id,
    ...
    SuadoitaikhoanComponent.prototype.SaveStudentEdit = function (id) {
        var index = this.students.indexOf(this.students.find(function (sv) { return sv.id === id; }));
    ...
    SuadoitaikhoanComponent.ctorParameters = function () { return [
        { type: _service_service__WEBPACK_IMPORTED_MODULE_2__["DataService"] }
    ]; };
    ...
    return SuadoitaikhoanComponent;
}());
...
var ThiTnComponent = /** @class */ (function () {
    //END đếm giờ
    function ThiTnComponent(ds, route, router) {
        this.ds = ds;
        this.route = route;
        this.router = router;
        this.dapAnUser = null;
    ...
    ThiTnComponent.prototype.handleEvent2 = function (e) {
        this.text = e.action;
        console.log(e);
        if (e.action == "done") {
    ...
    ThiTnComponent.prototype.ngOnInit = function () {
        var _this = this;
        //tìm tên môn học:
        this.ds.getSubjects().subscribe(function (data) {
            _this.ds.subjects = data;
            _this.route.paramMap.subscribe(function (params) {
                _this.Id = params.get('Id');
                _this.subject = _this.ds.subjects.find(function (x) {
                    return x.Id == _this.Id;
                });
                _this.tenMonHoc = _this.subject.Name;
                //END tìm tên mon học
                //tìm những câu hỏi:
                _this.ds.getQuiz(_this.Id).subscribe(function (data) {
                    _this.Quizs = data;
                });
            });
        });
    };
    ThiTnComponent.prototype.submit = function (quiz) {
        //TH chưa chọn đáp án :
    ...
    ThiTnComponent.prototype.Next = function () {
        this.dapAnUser = null;
        this.cur++;
    ...
    ThiTnComponent.prototype.timCauDung = function (dapAnDung, dapAn) {
        if (dapAnDung == dapAn && this.isSubmited == true) {
            return true;
        }
        return false;
    };
    ThiTnComponent.prototype.timCauSai = function (dapAnDung, dapAn) {
        if (dapAnDung != dapAn && this.isSubmited == true && dapAn == +this.backUpDapAnUser) {
            return true;
        }
        return false;
    };
    ThiTnComponent.prototype.countdown2 = function () {
    ...
    ThiTnComponent.ctorParameters = function () { return [
        { type: _service_service__WEBPACK_IMPORTED_MODULE_2__["DataService"] },
        { type: _angular_router__WEBPACK_IMPORTED_MODULE_3__["ActivatedRoute"] },
        { type: _angular_router__WEBPACK_IMPORTED_MODULE_3__["Router"] }
    ]; };
...
var TrangchuComponent = /** @class */ (function () {
    ...
    function TrangchuComponent(y, route) {
        this.y = y;
        this.route = route;
        this.STTCauHoi = 0;
    }
    TrangchuComponent.prototype.ngOnInit = function () {
        var _this = this;
        this.y.getSubjects().subscribe(function (data) {
            _this.listMonHoc = data;
